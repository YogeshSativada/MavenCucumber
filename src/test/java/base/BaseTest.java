...
import extentrepots.ExtentManager;
//import com.aventstack.extentreports.ExtentReports;
//import com.aventstack.extentreports.ExtentTest;
//
...
//	 to read properties files 
	...
	public void filesRead() throws IOException
	{
		System.out.println("In Before Test...");
		 fis1=new FileInputStream(System.getProperty("user.dir")+"\\src\\test\\resources\\TestData\\properties\\config.properties");
		 configProperties=new Properties();
		configProperties.load(fis1);
		
		 fis2=new FileInputStream(System.getProperty("user.dir")+"\\src\\test\\resources\\TestData\\properties\\config.properties");
